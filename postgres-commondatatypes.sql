...
DROP TABLE commondatatypes_new;
...
CREATE TABLE commondatatypes_new(
    ...
    col_year INTEGER,
    col_char TEXT,
    col_varchar CHARACTER VARYING(255) NOT NULL,
    col_binary BYTEA,
    col_varbinary BYTEA,
    col_blob BYTEA,
    col_text CHARACTER VARYING(255) DEFAULT 'Gopal',
    col_enum CHARACTER VARYING(255) DEFAULT 'PwC' NOT NULL,
    col_set CHARACTER VARYING(255)
);
